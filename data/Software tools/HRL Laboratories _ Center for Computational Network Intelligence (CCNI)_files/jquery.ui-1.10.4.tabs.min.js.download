...
(function (e) {
	...
	e.effects.effect.blind = function (s, a) {
		...
		h.parent().is(".ui-effects-wrapper") ? e.effects.save(h.parent(), l) : e.effects.save(h, l), h.show(), n = e.effects.createWrapper(h).css({
			overflow: "hidden"
		}), r = n[p](), o = parseFloat(n.css(m)) || 0, g[p] = v ? r : 0, f || (h.css(c ? "bottom" : "right", 0).css(c ? "top" : "left", "auto").css({
			position: "absolute"
		}), g[m] = v ? o : r + o), v && (n.css(p, 0), f || n.css(m, o + r)), n.animate(g, {
			duration: s.duration,
			easing: s.easing,
			queue: !1,
			complete: function () {
				"hide" === u && h.hide(), e.effects.restore(h, l), e.effects.removeWrapper(h), a()
			}
		})
	}
})(jQuery);
(function (e) {
	e.effects.effect.bounce = function (t, i) {
		...
		for ((u || l) && o.push("opacity"), e.effects.save(r, o), r.show(), e.effects.createWrapper(r), c || (c = r["top" === v ? "outerHeight" : "outerWidth"]() / 3), u && (n = {
				opacity: 1
			}, n[v] = 0, r.css("opacity", 0).css(v, y ? 2 * -c : 2 * c).animate(n, f, g)), l && (c /= Math.pow(2, p - 1)), n = {}, n[v] = 0, s = 0; p > s; s++) a = {}, a[v] = (y ? "-=" : "+=") + c, r.animate(a, f, g).animate(n, f, g), c = l ? 2 * c : c / 2;
		l && (a = {
			opacity: 0
...
(function (e) {
	e.effects.effect.puff = function (t, i) {
		...
		"show" === p && r.show(), s = {
			...
			easing: t.easing,
			complete: function () {
				0 === r.to.opacity && r.css("opacity", r.from.opacity), "hide" === p && r.hide(), e.effects.restore(r, y), m || ("static" === v ? r.css({
					position: "relative",
					top: r.to.top,
					left: r.to.left
...
(function (e) {
	e.effects.effect.shake = function (t, i) {
		var s, a = e(this),
			...
			v = a.queue(),
			y = v.length;
		for (e.effects.save(a, n), a.show(), e.effects.createWrapper(a), m[c] = (p ? "-=" : "+=") + h, f[c] = (p ? "+=" : "-=") + 2 * h, g[c] = (p ? "-=" : "+=") + 2 * h, a.animate(m, d, t.easing), s = 1; l > s; s++) a.animate(f, d, t.easing).animate(g, d, t.easing);
